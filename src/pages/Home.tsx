  ...
  return (
    <div className="bg-gray-950 min-h-screen">
      <div className="container-app">
        <section className="py-12 md:py-20 ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 item-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              ...
              <span className="text-green-500">DevBills</span>
            </h1>
            <p className="text-lg text-white mb-8">
              Uma plataforma simples e eficiente para controlar suas despesas e
        ...
        <section className="py-12 md:py-20">
          <div className="bg-gray-900 p-8 rouded-xl md:p-12 text-center border-gray-700 border  ">
